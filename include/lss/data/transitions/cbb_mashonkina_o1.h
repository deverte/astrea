...
struct CBBMashonkinaO1Transition {
   ...
   */
  std::function<double(double)> collision_rate_coefficient;
  /**
 ...
 */
 ...
 private:
  std::vector<CBBMashonkinaO1Transition> transitions_{
    {
      .initial = "12P3P4",
      .final = "12P1S4",
      .collision_rate_coefficients = {
        5.13e-31,
        4.28e-17,
        3.07e-14,
        1.34e-12,
...
CBBMashonkinaO1::CBBMashonkinaO1() {
  for (auto& transition : transitions_) {
    auto T = transition.temperatures;
    auto C = transition.collision_rate_coefficients;

    transition.collision_rate_coefficient = // cm^3 * s^{-1}
      _1D::LinearInterpolator<double>()
    ;
    transition.collision_rate_coefficient
...
double CBBMashonkinaO1::collision_rate_coefficient(
  ...
  for (auto transition : transitions_) {
    if (transition.initial == initial && transition.final == final) {
      return transition.collision_rate_coefficient(temperature);
    }
  }
  return 0.0;
}
