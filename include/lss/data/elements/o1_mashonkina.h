...
inline const std::vector<Level>& O1Mashonkina::all_levels() {
  return all_levels_;
}


inline const double O1Mashonkina::atomic_number() {
  return atomic_number_;
}


inline const double O1Mashonkina::ionization_stage() {
  return ionization_stage_;
}


inline const double O1Mashonkina::mass() {
  return mass_;
}


inline const std::vector<Level> O1Mashonkina::all_levels_{
  {
    .term = "12P3P4",
    .limit_term = "22P4S",
