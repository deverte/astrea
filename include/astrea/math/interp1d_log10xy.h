/**
 * \file astrea/math/interp1d_log10xy.h
...
namespace astrea::math::interp1d_log10xy {
...
inline double f(
  ...
  const auto ylog = astrea::math::interp1d_linear::f(
    x_Y.array().log10(),
    y_Y.array().log10(),
    std::log10(x)
  );
...
inline Eigen::VectorXd f_X(
  ...
  Eigen::VectorXd ylog_X = astrea::math::interp1d_linear::f_X(
    x_Y.array().log10(),
    y_Y.array().log10(),
    x_X.array().log10()
  );
