/**
 * \file astrea/transitions/tbr_mashonkina_o1_seaton_rate_coefficients.h
 * Three-body recombination rate coefficients for electrically neutral oxygen
 * using Mashonkina data and Seaton formula.
 * 
 * \copyright GPL
...
/**
 * Three-body recombination rate coefficients for electrically neutral oxygen
 * using Mashonkina data (from private communication) and Seaton formula
 * (isbn-9780120814503).
 * 
 ...
 */
inline Eigen::MatrixXd tbr_mashonkina_o1_seaton_rate_coefficients(
