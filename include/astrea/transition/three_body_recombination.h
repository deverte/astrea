/**
 * \file astrea/transition/three_body_recombination.h
 * Three-body recombination transition.
 * 
 * \copyright GPL
...
namespace astrea::transition::three_body_recombination {


/**
 * Three-body recombination transition rates calculation using LTE.
 * 
 * \param R_ZK Collisional ionization rates in s-1.
 ...
 * Three-body recombination transition rates calculation using LTE.
 * 
 * \param R_XZK Collisional ionization rates in s-1.
