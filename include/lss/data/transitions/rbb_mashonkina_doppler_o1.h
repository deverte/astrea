...
class RBBMashonkinaDopplerO1 {
 ...
 private:
  static const std::vector<RBBMashonkinaDopplerO1Transition> transitions_;
};


inline const std::vector<RBBMashonkinaDopplerO1Transition>&
...
inline const std::vector<RBBMashonkinaDopplerO1Transition>
RBBMashonkinaDopplerO1::transitions_{
  // {
  //   .initial = "12P3P4",
  //   .final = "13S3S",
