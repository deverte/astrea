...
inline const std::vector<Level>& He2::all_levels() {
  return all_levels_;
}


inline const double He2::atomic_number() {
  return atomic_number_;
}


inline const double He2::ionization_stage() {
  return ionization_stage_;
}


inline const double He2::mass() {
  return mass_;
}


inline const std::vector<Level> He2::all_levels_{};
